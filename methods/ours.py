...
class Client(Base_Client):
    def __init__(self, client_dict, args):
        ...
        self.offset = np.arange(0.0,1.0-self.width_range[0], 0.05)
    ...
    def train(self):
        ...
        for epoch in range(self.args.epochs):
            ...
            for batch_idx, (images, labels) in enumerate(self.train_dataloader):
                ...
                offset = 0 #self.offset[random.randint(0, len(self.offset)-1)]
                s_feats = self.model.reuse_feature(t_feats[-2].detach(), offset)
