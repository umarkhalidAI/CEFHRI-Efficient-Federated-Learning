...
class Client(Base_Client):
    def __init__(self, client_dict, args):
        ...
        if args.optimizer =="NGF":
            base_optimizer=NGF_Optimizer
            kwargs = dict(lr=self.args.lr, momentum=0.9, weight_decay=self.args.weight_decay)
            self.optimizer = base_optimizer(self.model, **kwargs)
